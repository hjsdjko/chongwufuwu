...
public class XihuOrderView extends XihuOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String xihuOrderValue;
		/**
		* 支付类型的值
		*/
		private String xihuOrderPaymentValue;
	...
	public XihuOrderView() {

	}

	public XihuOrderView(XihuOrderEntity xihuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, xihuOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getXihuOrderValue() {
				return xihuOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setXihuOrderValue(String xihuOrderValue) {
				this.xihuOrderValue = xihuOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getXihuOrderPaymentValue() {
				return xihuOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setXihuOrderPaymentValue(String xihuOrderPaymentValue) {
				this.xihuOrderPaymentValue = xihuOrderPaymentValue;
			}
