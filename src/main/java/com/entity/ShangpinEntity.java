...
public class ShangpinEntity<T> implements Serializable {
     ...
     * 商品视频
     */
    @TableField(value = "shangpin_video")

    private String shangpinVideo;
	 ...
	 * 设置：商品视频
	 */
    public String getShangpinVideo() {
        return shangpinVideo;
    }
    ...
    public void setShangpinVideo(String shangpinVideo) {
        this.shangpinVideo = shangpinVideo;
    }
    /**
	 * 设置：商品类型
	 */
